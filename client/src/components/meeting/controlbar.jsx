  ...
  return (
    <div className="bg-white border-t border-slate-200/90 px-4 sm:px-8 py-3 flex flex-col sm:flex-row gap-3 items-center justify-between shrink-0 shadow-xs z-40 relative">
      ...
      <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap justify-center">
        ...
        >
          {audioEnabled ? <Mic className="w-4 h-4 sm:w-4.5 sm:h-4.5" /> : <MicOff className="w-4 h-4 sm:w-4.5 sm:h-4.5" />}
        </button>
        ...
        >
          {videoEnabled ? <Video className="w-4 h-4 sm:w-4.5 sm:h-4.5" /> : <VideoOff className="w-4 h-4 sm:w-4.5 sm:h-4.5" />}
        </button>
        ...
        <button
          ...
          title="Open Shared Meeting Notes"
        >
        ...
        >
          {isRecording ? <Square className="w-4 h-4 sm:w-4.5 sm:h-4.5" /> : <Circle className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-rose-500 fill-rose-500" />}
        </button>
